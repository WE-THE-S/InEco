...
class Communication{
    protected:
        ...
        queue<device_communication_message_t> sendQueue;

    public:
    Communication(HardwareSerial _master, HardwareSerial _right, HardwareSerial _bottom) 
    ...
    Communication() : Communication(Serial, RightSerial, BottomSerial) {
